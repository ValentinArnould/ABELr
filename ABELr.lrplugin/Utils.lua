...
-- ABELr.lrplugin/ embarque tout (app/, launch.ps1, bootstrap.ps1) — plus besoin
...
-- Dossier de l'app Python (.../ABELr.lrplugin/app).
function Utils.appDir()
    return LrPathUtils.child(Utils.projectRoot(), 'app')
end

-- Répertoire des miniatures temporaires (.../ABELr.lrplugin/tmp_thumbs).
